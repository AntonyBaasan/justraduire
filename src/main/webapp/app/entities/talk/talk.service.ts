...
export class TalkService {
    ...
    private convertItemFromServer(talk: Talk): Talk {
        ...
        copy.date = this.dateUtils
            .convertLocalDateFromServer(talk.date);
        copy.serverDate = this.dateUtils
            .convertLocalDateFromServer(talk.serverDate);
        return copy;
    }
    ...
    private convert(talk: Talk): Talk {
        const copy: Talk = Object.assign({}, talk);
        copy.date = this.dateUtils
            .convertLocalDateToServer(talk.date);
        copy.serverDate = this.dateUtils
            .convertLocalDateToServer(talk.serverDate);
        return copy;
    }
}
