...
import { ConversationDialogComponent } from '../../../../../../main/webapp/app/entities/conversation/conversation-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Conversation Management Dialog Component', () => {
        let comp: ConversationDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(ConversationDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'conversationListModification', content: 'OK'});
